 ...
 * 
 * $Id: talend-code-templates.xml 1 2006-09-29 17:06:40 +0000 (2006) nrousseau $
 * 
 */
...
public class GlobalServiceRegister {
	...
	private IConfigurationElement[] getConfigurationElements() {
		if (configurationElements == null) {
			...
			configurationElements = (registry == null ? null : registry.getConfigurationElementsFor("org.talend.core.runtime.service")); //$NON-NLS-1$
		}
	...
	private IConfigurationElement[] getConfigurationDQModelElements() {
		if (configurationDQModelElements == null) {
			IExtensionRegistry registry = Platform.getExtensionRegistry();
			configurationDQModelElements = (registry == null ? null : registry.getConfigurationElementsFor("org.talend.core.runtime.dq_EMFModel_provider")); //$NON-NLS-1$
		}
	 ...
	 * 
	 * @param klass
	 *            the Service type you want to get
	 ...
	 * 
	 * @param klass
	 *            the interface type want to find.
	 * @return IService
	 */
